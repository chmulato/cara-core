...
# -*- coding: utf-8 -*-
"""
Script para converter um arquivo Markdown (SERVICEGUIDE.md) em HTML responsivo para leitura em tablets e dispositivos móveis.

Funcionalidades:
- Converte o arquivo SERVICEGUIDE.md em SERVICEGUIDE.html usando Pandoc.
